...
static const struct nu_uart_modinit_s uart_modinit_tab[] = {
    {UART0_MODULE, CLK_CLKSEL1_UART0SEL_PCLK0, MODULE_NoMsk, UART0_RST, UART0_IRQn, NULL},
    {UART1_MODULE, CLK_CLKSEL1_UART0SEL_PCLK0, MODULE_NoMsk, UART1_RST, UART1_IRQn, NULL},
...
void UartMcuConfig( Uart_t *obj, UartMode_t mode, uint32_t baudrate, WordLength_t wordLength, StopBits_t stopBits, Parity_t parity, FlowCtrl_t flowCtrl )
{
	...
	//line configure
	UART_SetLine_Config(psUARTHandle->uart_base, baudrate, u32DataWidth, u32Parity, u32StopBits);
