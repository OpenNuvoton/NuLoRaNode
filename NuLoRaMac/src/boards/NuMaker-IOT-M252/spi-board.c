...
static const struct nu_spi_modinit_s spi_modinit_tab[] = {
    {SPI0_MODULE, CLK_CLKSEL2_SPI0SEL_PCLK1, MODULE_NoMsk, SPI0_RST, SPI0_IRQn, NULL},
...
void SpiInit( Spi_t *obj, SpiId_t spiId, PinNames mosi, PinNames miso, PinNames sclk, PinNames nss )
{
	...
	if(spiId == SPI_1)
	{
		//Using SPI0 instance for SPI_1 id
		s_asSPIHandle[SPI_1].spi_base = SPI0;

		//Set SPI multple function pin
		GpioInit( &obj->Mosi, mosi, PIN_ALTERNATE_FCT, PIN_PUSH_PULL, PIN_PULL_DOWN, SPI0_MFP_MOSI_VALUE );
		GpioInit( &obj->Miso, miso, PIN_ALTERNATE_FCT, PIN_PUSH_PULL, PIN_PULL_DOWN, SPI0_MFP_MISO_VALUE );
		GpioInit( &obj->Sclk, sclk, PIN_ALTERNATE_FCT, PIN_PUSH_PULL, PIN_PULL_DOWN, SPI0_MFP_CLK_VALUE );
		GpioInit( &obj->Nss, nss, PIN_ALTERNATE_FCT, PIN_PUSH_PULL, PIN_PULL_UP, SPI0_MFP_NSS_VALUE );
	}
	else
	{
		printf("ERROR! %s, %s, %d \n", __FILE__, __FUNCTION__, __LINE__);
